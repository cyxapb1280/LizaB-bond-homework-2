...
MyUnit._earnExperiance(10)
MyUnit.takeDamage(121)
//MyUnit.addHealth(20)
console.log('MyUnit', MyUnit)

console.log('MyUnit.getName: ', MyUnit.getName())
console.log('MyUnit.getName: ', MyUnit.getLevel())
...
/*Object.defineProperties(Unit, {
    name:{
        get: () => this.name,
        set: (val) => val ? this.name = val : new Error("Name can't be empty")
    },
